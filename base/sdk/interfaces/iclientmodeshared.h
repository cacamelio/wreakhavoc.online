...
public:
	...
	int				iClockDriftMgr;			// 0x0124
	std::byte		pad4[0x44];				// 0x0168
	int				iServerTick;			// 0x016Ñ
	int				iClientTick;			// 0x0170
	int				iDeltaTick;				// 0x0174
	bool			bPaused;				// 0x0178
	std::byte		pad5[0x7];				// 0x0179
	...
	std::byte		pad9[0x50];				// 0x4D40
	QAngle			angViewPoint;			// 0x4D90
	std::byte		pad10[0xD0];			// 0x4D9C
